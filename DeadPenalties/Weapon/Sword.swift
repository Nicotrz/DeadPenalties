...
class Sword: Weapon {
    ...
    init() {
        super.init(type: Sword.type, givePoints: Sword.givePoints, affectedPoints: Sword.affectedPoints, magicalWeapon: Sword.magicalWeapon, affectedMana: Sword.affectedMana )
    }
